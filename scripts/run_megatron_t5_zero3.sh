...
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/megatron_zero3}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${OUTPUT_DIR}/checkpoints}"
SPLIT_SENTENCES="${SPLIT_SENTENCES:-0}"
DS_CONFIG="${DS_CONFIG:-${PROJECT_DIR}/ds_configs/megatron_zero3.json}"
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-megatron-zero3-xsum}"
...
echo "=== Megatron T5 ZeRO-3 (XSum corpus) ==="
