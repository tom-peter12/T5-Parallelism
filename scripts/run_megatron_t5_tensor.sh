...
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/megatron_tp}"
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-megatron-tensor-xsum}"
...
echo "=== Megatron T5 Tensor Parallel (XSum corpus) ==="
...
torchrun \
  ...
  --rdzv_id=t5_megatron_tensor_job \
  --rdzv_backend=c10d \
