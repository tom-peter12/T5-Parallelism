...
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/megatron_ddp}"
...
# Pure data parallelism: TP=1, PP=1 — all GPUs are data-parallel replicas
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-megatron-ddp-xsum}"
...
echo "=== Megatron T5 DDP Baseline (XSum corpus) ==="
