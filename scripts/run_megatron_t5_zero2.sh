...
MASTER_PORT="${MASTER_PORT:-29802}"
NNODES="${NNODES:-${#HOST_ARRAY[@]}}"
NPROC="${NPROC:-1}"

export CUDA_DEVICE_MAX_CONNECTIONS=1

OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_DIR}/outputs/megatron_zero2}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-${OUTPUT_DIR}/checkpoints}"
SPLIT_SENTENCES="${SPLIT_SENTENCES:-0}"
DS_CONFIG="${DS_CONFIG:-${PROJECT_DIR}/ds_configs/megatron_zero2.json}"
...
WANDB_RUN_NAME="${WANDB_RUN_NAME:-megatron-zero2-xsum}"
...
echo "=== Megatron T5 ZeRO-2 (XSum corpus) ==="
